...
class Order(models.Model):
    """
    Заказ (он же корзина, если status == 'basket')
    """
    ...
    profile = models.ForeignKey(Profile, verbose_name='Контакт',
...
class OrderItem(models.Model):
    """
    Ссылка на продукт в заказе (или корзине), а также его количество
    """
